<?php
include 'koneksi.php';
$idwomen = $_GET['idwomen'];
$result = mysqli_query($koneksi, "SELECT * FROM women WHERE idwomen='$idwomen'");
...
<html lang="en">
 ...
 <h1> Ubah Data Sepatu Wanita</h1><hr>
<form action="update_women.php" method="post">
 <div class="form-row">
 <div class="form-group col-md-4">
 <label >ID</label>
    <input type="text" name="idwomen" class="form-control" id="idwomen" value="<?php echo $idwomen;?>">
 </div>
 </div>
 <div class="form-row">
