...
<section>
  ...
  <div class="col-md-10 p-5 pt-2">
    <h1><i class="fas fa-socks mr-2"></i> Sepatu Pria </h1><hr>
        <a href="tambah_men.php" class="btn btn-secondary mb-2"> <i class="fas fa-plus-circle mr-2"></i>TAMBAH DATA BARANG</a>
  ...
  <tr>
    ...
    <td><i class="fas fa-edit bg-success p-2 text-white rounded"></i>
      <a href="ubah_men.php?idmen=<?php echo $data['idmen']; ?>">Edit</a>|
      <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
      <a href="hapus_men.php?idmen=<?php echo $data['idmen']; ?>">Delete</a></tr></td></tr>
      <?php
  }
  ?>
      <a href="laporanmen.php" class="btn btn-secondary mb-2"></i>CETAK DATA BARANG</a>
      </table>
  </div>
